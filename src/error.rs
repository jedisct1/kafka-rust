...
impl From<ssl::error::Error> for Error {
    fn from(err: ssl::error::Error) -> Error { Error::Ssl(err) }
}
    ...
    fn clone(&self) -> Error {
        match self {
            ...
            &Error::Ssl(ref x) => match x {
                &ssl::error::Error::Stream(ref e) =>
                    Error::Ssl(ssl::error::Error::Stream(
                            io::Error::new(e.kind(), "Stream Error"))
                    ),
                &ssl::error::Error::ZeroReturn =>
                    Error::Ssl(ssl::error::Error::ZeroReturn),
                &ssl::error::Error::WantX509Lookup =>
                    Error::Ssl(ssl::error::Error::WantX509Lookup),
                &ssl::error::Error::WantRead(ref e) =>
                    Error::Ssl(ssl::error::Error::WantRead(
                            io::Error::new(e.kind(), "Wait for read readiness"))
                    ),
                &ssl::error::Error::WantWrite(ref e) =>
                    Error::Ssl(ssl::error::Error::WantWrite(
                            io::Error::new(e.kind(), "Wait for write readiness"))
                    ),
                &ssl::error::Error::Ssl(_) =>
                    Error::Ssl(ssl::error::Error::Stream(
                            io::Error::new(io::ErrorKind::Other, "OpenSSL error"))
                    )
            },
